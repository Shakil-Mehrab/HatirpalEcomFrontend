<template>
  <div class="row hatirpal_info">
    <div class="col-md-9">
      <ul class="lower_info_ul">
        <li class="animate-expand px-2 text-sm font-semibold">
        ...
        <!-- <li class="animate-expand px-2 text-sm font-semibold"><a href="">Help </a></li> -->
      </ul>
    </div>
